...
resource "aws_route53_record" "www_api_colours_hapax_record" {
    ...
    alias {
        name                   = aws_apigatewayv2_domain_name.colours_hapax.domain_name_configuration[0].target_domain_name
        zone_id                = aws_apigatewayv2_domain_name.colours_hapax.domain_name_configuration[0].hosted_zone_id
        evaluate_target_health = false
    }
}
